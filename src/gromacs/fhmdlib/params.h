...
enum FHMD_NF     {constantflow, poiseuille, couette};

enum FHMD_CELL   {FH_zone, hybrid_zone, boundary};

#define FHMD_T_DOF              2               /* 2 for SPC/E */
#define FHMD_T_DOF_Ar           3               /* 3 for Ar */
#define FHMD_FLOW_LAYERS        10              /* Number of layers for non-equilibrium averaging */
#define FHMD_FLOW_LAYERS_Y      20              /* Number of layers for non-equilibrium flow */
